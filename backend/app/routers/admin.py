...
def get_pending_submissions(
    ...
    try:
        ...
        # Filter by status - show pending, generating and generated by default
        if status == "pending":
            # Show pending (awaiting generation), generating (in progress), and generated (awaiting approval)
