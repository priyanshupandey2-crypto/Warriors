...
class TopicCleanerService:
    ...
    NOISE_TERMS = {
        ...
        # REMOVED: SQL keywords like SELECT, JOIN, INDEX, VIEW, TRIGGER
        # REASON: These ARE learning concepts in SQL/Database domains
        # They were being incorrectly filtered, breaking SQL curricula
        # New architecture will use domain-aware filtering instead of hardcoded lists
    }
